...
constrs["TransactionBuilderStep"]="SpendOutput, Pay, MintAsset, RegisterStake, IssueCertificate, WithdrawStake, RequireSignature, RegisterPool, RetirePool, IncludeDatum, SetTTL, SetValidityStartInterval, SetIsValid, DeregisterStake"
...
constrs["Certificate"]="StakeRegistration, StakeDeregistration, StakeDelegation, PoolRegistration, PoolRetiremen, GenesisKeyDelegatio, MoveInstantaneousRewardsCert"
constrs["PlutusData"]="Constr, Map, List, Integer, Bytes"
constrs["NativeScript"]="ScriptPubkey, ScriptAll, ScriptAny, ScriptNOfK, TimelockStart, TimelockExpiry"
